const socialLinks = [
  {
    href: "https://www.facebook.com/aurumnetworkofficial",
    label: "Facebook",
    icon: (
      <svg
        fill="none"
      ...
      >
        <path
          d="M17.525 8.999h-3.025V7.5c0-.482.393-.875.875-.875h2.15a.75.75 0 0 0 0-1.5h-2.15A2.375 2.375 0 0 0 12.025 7.5v1.499H10.5a.75.75 0 0 0 0 1.5h1.525V18a.75.75 0 0 0 1.5 0V10.5h2a.75.75 0 0 0 0-1.5Z"
          fill="#fff"
        />
      </svg>
    ),
  ...
  {
    href: "https://www.instagram.com/aurumnetworkofficial/",
    label: "Instagram",
    icon: (
      <svg
        fill="none"
  ...
  {
    href: "https://x.com/aurumnetworkhq",
    label: "X",
    icon: (
      <svg
        fill="none"
  ...
  {
    href: "https://www.linkedin.com/company/aurumneworkofficial/",
    label: "LinkedIn",
    icon: (
      <svg
        fill="none"
      ...
      >
        ...
        />
        <path
          d="M8 11v5M8 8v.01M12 11v5m0 0v-2.5a2.5 2.5 0 0 1 5 0V16"
          stroke="#fff"
          strokeWidth="2"
          strokeLinecap="round"
        />
  ...
  {
    href: "https://t.me/+ZjoFH1LibLRhZjg1",
    label: "Telegram",
    icon: (
      <svg
        fill="none"
      ...
      >
        <path
          d="M20.944 4.438a1.5 1.5 0 0 0-1.64-.217L4.5 11.5a1.5 1.5 0 0 0 .13 2.77l3.47 1.23 1.23 3.47a1.5 1.5 0 0 0 2.77.13l7.28-14.804a1.5 1.5 0 0 0-.436-1.858Z"
          fill="#fff"
        />
      </svg>
    ),
...
export const Footer = () => {
  return (
    <footer className="w-full bg-transparent pt-4 pb-8 px-4 flex flex-col items-center relative z-10">
          ...
          <div className="flex flex-row items-center sm:items-start gap-8 sm:gap-x-24 mt-4 sm:mt-0 sm:hidden">
            ...
            <div className="flex flex-col items-center sm:items-start">
              ...
              <ul className="space-y-2 text-center sm:text-left">
                <li>
                  <a
                    href="https://aurumnetwork.io/blog/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-neutral-300 hover:text-[#e59445] transition"
                  >
                ...
                <li>
                  <a
                    href="https://aurumnetwork.io/privacy-policy/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-neutral-300 hover:text-[#e59445] transition"
                  >
      ...
      {/* Divider */}
      <div
        className="w-full max-w-6xl h-1 my-8 rounded-full"
        style={{
          background:
