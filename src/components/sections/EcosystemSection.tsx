...
const QRCodeComponent = ({ size = 160 }: { size?: number }) => (
  ...
  >
    <div className="w-full h-full bg-white rounded-xl relative overflow-hidden p-2">
  <QRCode
...
export const EcosystemSection = () => {
  ...
  return (
    <section id="learn-more" className="w-full py-16 px-4 sm:px-8 md:px-16 lg:px-0 flex flex-col items-center bg-body relative">
      ...
      >
        ...
        <motion.div 
          className="w-full max-w-5xl h-1 my-2 rounded-full relative overflow-hidden"
          style={{
      ...
      <div className="w-full max-w-7xl flex flex-col gap-8 lg:flex-row lg:gap-24 mt-16 relative z-10 justify-center">
        ...
        >
          <motion.div
            ...
            style={{
              background: 'linear-gradient(135deg, #e59445 0%, #7f5026 50%, #e59445 100%)',
            }}
            ...
            <div ref={formRef} className="w-full bg-hero rounded-3xl p-12 shadow-2xl relative overflow-hidden backdrop-blur-sm">
              ...
              <div className="relative z-10">
                ...
                {showSuccessMessage && (
                  ...
                  >
                    <div className="text-center">
                      ...
                      <p className="text-neutral-300">Redirecting to webinar...</p>
                    </div>
                  </motion.div>
                )}
                ...
                <div className="text-center mb-8">
                  <h3 className="text-2xl font-bold text-white mb-2">Join The Gold Revolution</h3>
                  <p className="text-neutral-400">Fill out the form to join the webinar and learn more</p>
                </div>

                <div className="flex flex-col md:flex-row gap-6 mb-6">
                  {/* Name */}
                  <div className="flex-1 flex flex-col gap-3">
                    <label className="text-white text-sm font-semibold tracking-wide">Your Name</label>
                    <input 
                      type="text" 
                      name="name"
                      value={formData.name}
                  ...
                  {/* Email */}
                  <div className="flex-1 flex flex-col gap-3">
                    <label className="text-white text-sm font-semibold tracking-wide">Email Address</label>
                    <input 
                      type="email" 
                      name="email"
                ...
                <div className="flex flex-col gap-3 mb-6">
                  <label className="text-white text-sm font-semibold tracking-wide">Phone Number</label>
                  <input 
                    type="tel" 
                    name="phone"
                ...
                <div className="flex flex-col gap-3 mb-8">
                  <label className="text-white text-sm font-semibold tracking-wide">Message</label>
                  <textarea 
                    name="message"
              ...
              Submit
                ...
                >
                  ...
                  <div className="flex items-center justify-center gap-2 mb-4">
                    ...
                    <a href="https://aurumplatform.io/register?ref=5413444d9eea0a4a0c2820241029133847607" target="_blank" 
                            rel="noopener noreferrer">
                                        <motion.span
                      className="text-transparent text-sm font-semibold tracking-wider bg-clip-text"
                      style={{
                        backgroundImage: 'linear-gradient(90deg, #e59445,rgb(220, 154, 95), #e59445)',
                      ...
                      animate={{
                        backgroundPosition: ['40% center', '100% center', '40% center'],
                      }}
                      transition={{
                        duration: 7.5,
                        repeat: Infinity,
                  ...
                  <p className="text-neutral-400 text-sm">
                    Join thousands of investors already part of the gold revolution
                  </p>
                </motion.div>
              </div>
            </div>
        ...
        >
          ...
          >
            <div className="flex flex-col items-center gap-6">
              <div className="text-center">
                ...
                <p className="text-neutral-400 text-sm">Scan to join instantly</p>
              </div>
              
              <QRCodeComponent size={180} />
              
              <div className="text-center">
                <p className="text-neutral-300 text-sm mb-2">Or visit directly:</p>
                <motion.a 
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full max-w-sm">
            ...
            >
              ...
              <h4 className="text-white font-semibold text-sm mb-1">Instant Access</h4>
              <p className="text-neutral-400 text-xs">Get immediate entry by registering directly</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-neutral-400 text-xs">Your information is protected with us</p>
            </motion.div>
          </div>
        </motion.div>
      </div>
